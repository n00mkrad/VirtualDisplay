...
NTSTATUS IddSampleMonitorQueryModes(IDDCX_MONITOR MonitorObject, const IDARG_IN_QUERYTARGETMODES* pInArgs, IDARG_OUT_QUERYTARGETMODES* pOutArgs)
{
	...
	TargetModes.push_back(CreateIddCxTargetMode(3840, 2160, 144));
	TargetModes.push_back(CreateIddCxTargetMode(3840, 2160, 120));
	TargetModes.push_back(CreateIddCxTargetMode(3840, 2160, 90));
	TargetModes.push_back(CreateIddCxTargetMode(3840, 2160, 60));
	TargetModes.push_back(CreateIddCxTargetMode(3840, 2160, 30));

	TargetModes.push_back(CreateIddCxTargetMode(2560, 1600, 144));
	TargetModes.push_back(CreateIddCxTargetMode(2560, 1600, 120));
	TargetModes.push_back(CreateIddCxTargetMode(2560, 1600, 90));
	TargetModes.push_back(CreateIddCxTargetMode(2560, 1600, 60));
	TargetModes.push_back(CreateIddCxTargetMode(2560, 1600, 30));
	...
	TargetModes.push_back(CreateIddCxTargetMode(2560, 1440, 30));
	...
	TargetModes.push_back(CreateIddCxTargetMode(1920, 1080, 30));

	TargetModes.push_back(CreateIddCxTargetMode(1280, 800, 144));
	TargetModes.push_back(CreateIddCxTargetMode(1280, 800, 120));
	TargetModes.push_back(CreateIddCxTargetMode(1280, 800, 90));
	TargetModes.push_back(CreateIddCxTargetMode(1280, 800, 60));
	TargetModes.push_back(CreateIddCxTargetMode(1280, 800, 30));

	TargetModes.push_back(CreateIddCxTargetMode(1280, 720, 144));
	TargetModes.push_back(CreateIddCxTargetMode(1280, 720, 120));
	TargetModes.push_back(CreateIddCxTargetMode(1280, 720, 90));
	TargetModes.push_back(CreateIddCxTargetMode(1280, 720, 60));
	TargetModes.push_back(CreateIddCxTargetMode(1280, 720, 30));

	TargetModes.push_back(CreateIddCxTargetMode(1200, 540, 144));
	TargetModes.push_back(CreateIddCxTargetMode(1200, 540, 120));
	TargetModes.push_back(CreateIddCxTargetMode(1200, 540, 90));
	TargetModes.push_back(CreateIddCxTargetMode(1200, 540, 60));
	TargetModes.push_back(CreateIddCxTargetMode(1200, 540, 30));

	TargetModes.push_back(CreateIddCxTargetMode(960, 540, 144));
	TargetModes.push_back(CreateIddCxTargetMode(960, 540, 120));
